...
{- | Fields :
         ...
         * 'Proto.Configdt_Fields.generic' @:: Lens' Modconf Proto.Sensors.Genericdt.Genericopt@
         * 'Proto.Configdt_Fields.maybe'generic' @:: Lens' Modconf (Prelude.Maybe Proto.Sensors.Genericdt.Genericopt)@ -}
data Modconf
  = Modconf'_constructor {_Modconf'raspCam :: !(Prelude.Maybe Proto.Sensors.Raspcamdt.Raspcamopt),
                          ...
                          _Modconf'generic :: !(Prelude.Maybe Proto.Sensors.Genericdt.Genericopt),
  ...
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _Modconf'system (\ x__ y__ -> x__ {_Modconf'system = y__}))
        Prelude.id
instance Data.ProtoLens.Field.HasField Modconf "generic" Proto.Sensors.Genericdt.Genericopt where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _Modconf'generic (\ x__ y__ -> x__ {_Modconf'generic = y__}))
        (Data.ProtoLens.maybeLens Data.ProtoLens.defMessage)
instance Data.ProtoLens.Field.HasField Modconf "maybe'generic" (Prelude.Maybe Proto.Sensors.Genericdt.Genericopt) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _Modconf'generic (\ x__ y__ -> x__ {_Modconf'generic = y__}))
...
instance Data.ProtoLens.Message Modconf where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ACKsystem\CAN\ETX \SOH(\v2\ESC.sensors.systemdt.SystemoptR\ACKsystem\DC27\n\
      \\ageneric\CAN\EOT \SOH(\v2\GS.sensors.genericdt.GenericoptR\ageneric"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        ...
        generic__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              "generic"
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Sensors.Genericdt.Genericopt)
              (Data.ProtoLens.OptionalField
  ...
  defMessage
    = Modconf'_constructor
        {_Modconf'raspCam = Prelude.Nothing,
         ...
         _Modconf'generic = Prelude.Nothing, _Modconf'_unknownFields = []}
  parseMessage
    = let
        ...
        -> (Data.Monoid.<>)
             ...
             ((Data.Monoid.<>)
                ...
                ((Data.Monoid.<>)
                   ...
                   ((Data.Monoid.<>)
                      (case
                           Lens.Family2.view (Data.ProtoLens.Field.field @"maybe'generic") _x
                       of
                         Prelude.Nothing -> Data.Monoid.mempty
                         (Prelude.Just _v)
                           -> (Data.Monoid.<>)
        ...
        -> Control.DeepSeq.deepseq
             ...
             (Control.DeepSeq.deepseq
                ...
                (Control.DeepSeq.deepseq
                   ...
                   (Control.DeepSeq.deepseq
                      (_Modconf'system x__)
                      (Control.DeepSeq.deepseq (_Modconf'generic x__) ()))))
{- | Fields :
...
packedFileDescriptor
  = "\n\
    \\SOconfigdt.proto\DC2\bconfigdt\SUB\ETBsensors/raspcamdt.proto\SUB\DC3sensors/cpudt.proto\SUB\SYNsensors/systemdt.proto\SUB\ETBsensors/genericdt.proto\"2\n\
    \\EOTTime\DC2\DC2\n\
    \\EOThour\CAN\SOH \SOH(\ENQR\EOThour\DC2\SYN\n\
    \\ACKminute\CAN\STX \SOH(\ENQR\ACKminute\"\218\SOH\n\
    \\aModconf\DC28\n\
    \\brasp_cam\CAN\SOH \SOH(\v2\GS.sensors.raspcamdt.RaspcamoptR\araspCam\DC2'\n\
    \\ETXcpu\CAN\STX \SOH(\v2\NAK.sensors.cpudt.CpuoptR\ETXcpu\DC23\n\
    \\ACKsystem\CAN\ETX \SOH(\v2\ESC.sensors.systemdt.SystemoptR\ACKsystem\DC27\n\
    \\ageneric\CAN\EOT \SOH(\v2\GS.sensors.genericdt.GenericoptR\ageneric\"\133\STX\n\
    \\aDevconf\DC2\ESC\n\
    \\tmqtt_host\CAN\SOH \SOH(\tR\bmqttHost\DC2\ESC\n\
    \\tmqtt_user\CAN\ETX \SOH(\tR\bmqttUser\DC2\ESC\n\
    \\tmqtt_pass\CAN\EOT \SOH(\tR\bmqttPass\DC2%\n\
    ...
    \\DLE\DC1\n\
    \\v\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX\v\ETX\DC4\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ENQ\DC2\ETX\v\ETX\b\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\SOH\DC2\ETX\v\t\SI\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ETX\DC2\ETX\v\DC2\DC3\n\
    \\n\
    \\n\
    ...
    \\v\n\
    \\EOT\EOT\SOH\STX\NUL\DC2\ETX\SI\ETX-\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ACK\DC2\ETX\SI\ETX\US\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\SOH\DC2\ETX\SI (\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ETX\DC2\ETX\SI+,\n\
    \\v\n\
    \\EOT\EOT\SOH\STX\SOH\DC2\ETX\DLE\ETX \n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\ACK\DC2\ETX\DLE\ETX\ETB\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\SOH\DC2\ETX\DLE\CAN\ESC\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\ETX\DC2\ETX\DLE\RS\US\n\
    \\v\n\
    \\EOT\EOT\SOH\STX\STX\DC2\ETX\DC1\ETX)\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\STX\ACK\DC2\ETX\DC1\ETX\GS\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\STX\SOH\DC2\ETX\DC1\RS$\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\STX\ETX\DC2\ETX\DC1'(\n\
    \\v\n\
    \\EOT\EOT\SOH\STX\ETX\DC2\ETX\DC2\ETX,\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\ETX\ACK\DC2\ETX\DC2\ETX\US\n\
    \\f\n\
    ...
    \\n\
    \\n\
    \\STX\EOT\STX\DC2\EOT\NAK\NUL\GS\SOH\n\
    \\n\
    \\n\
    \\ETX\EOT\STX\SOH\DC2\ETX\NAK\b\SI\n\
    \\v\n\
    \\EOT\EOT\STX\STX\NUL\DC2\ETX\SYN\ETX\CAN\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\NUL\ENQ\DC2\ETX\SYN\ETX\t\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\NUL\SOH\DC2\ETX\SYN\n\
    \\DC3\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\NUL\ETX\DC2\ETX\SYN\SYN\ETB\n\
    \\v\n\
    \\EOT\EOT\STX\STX\SOH\DC2\ETX\ETB\ETX\CAN\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\SOH\ENQ\DC2\ETX\ETB\ETX\t\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\SOH\SOH\DC2\ETX\ETB\n\
    \\DC3\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\SOH\ETX\DC2\ETX\ETB\SYN\ETB\n\
    \\v\n\
    \\EOT\EOT\STX\STX\STX\DC2\ETX\CAN\ETX\CAN\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\STX\ENQ\DC2\ETX\CAN\ETX\t\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\STX\SOH\DC2\ETX\CAN\n\
    \\DC3\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\STX\ETX\DC2\ETX\CAN\SYN\ETB\n\
    \\v\n\
    \\EOT\EOT\STX\STX\ETX\DC2\ETX\EM\ETX\FS\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ETX\ENQ\DC2\ETX\EM\ETX\b\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ETX\SOH\DC2\ETX\EM\t\ETB\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ETX\ETX\DC2\ETX\EM\SUB\ESC\n\
    \\v\n\
    \\EOT\EOT\STX\STX\EOT\DC2\ETX\SUB\ETX\EM\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\EOT\ENQ\DC2\ETX\SUB\ETX\b\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\EOT\SOH\DC2\ETX\SUB\t\DC4\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\EOT\ETX\DC2\ETX\SUB\ETB\CAN\n\
    \\v\n\
    \\EOT\EOT\STX\STX\ENQ\DC2\ETX\ESC\ETX\GS\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ENQ\EOT\DC2\ETX\ESC\ETX\v\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ENQ\ACK\DC2\ETX\ESC\f\DLE\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ENQ\SOH\DC2\ETX\ESC\DC1\CAN\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ENQ\ETX\DC2\ETX\ESC\ESC\FS\n\
    \\v\n\
    \\EOT\EOT\STX\STX\ACK\DC2\ETX\FS\ETX\ESC\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ACK\ACK\DC2\ETX\FS\ETX\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ACK\SOH\DC2\ETX\FS\v\SYN\n\
    \\f\n\
    \\ENQ\EOT\STX\STX\ACK\ETX\DC2\ETX\FS\EM\SUBb\ACKproto3"